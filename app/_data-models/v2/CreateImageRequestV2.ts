...
import { Common, ImageSize } from '_types'
...
import DefaultPromptInputV2 from './DefaultPromptInputV2'
...
class CreateImageRequestV2 {
  ...
  static toDefaultPromptInput = (
    ...
    const promptInput: DefaultPromptInputV2 = {
      ...
      useHordeBatching: false,
      useMultiClip: false,
      useMultiDenoise: false,
      useMultiGuidance: false,
      useMultiPresets: false,
      useMultiSamplers: false,
      useMultiSteps: false,
      useXyPlot: false,
