...
- When a source image is present, lock aspect on inital load of the image orientation options (allows you to easily resize an image request if source image is too large).
